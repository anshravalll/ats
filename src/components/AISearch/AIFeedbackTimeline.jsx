      ...
      details: (
        <div>
          <div className="text-xs text-muted-foreground mb-1">
            Typing: <span className="font-mono text-foreground">"{query}"</span>
          </div>
          {filterPlan && (
            <>
        ...
        <div>
          ...
          {typeof candidateCount === "number" && (
            <div className="text-xs mt-1">
              {candidateCount} candidates ranked
            </div>
          )}
          {rankedIds && rankedIds.length > 0 && (
            <div className="flex flex-wrap gap-1 mt-2">
              {rankedIds.slice(0, 10).map((id, i) => (
                <span
                  key={id}
                  className="px-2 py-0.5 rounded bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-200 text-xs font-mono"
                >
                  #{id}
                </span>
              ))}
    ...
    },
    {
      ...
      details: (
        <div>
          ...
          {summary ? (
            <div className="text-sm mt-2 whitespace-pre-line text-foreground">
              {summary}
            </div>
          ) : (
      ...
      {!collapsed && (
        ...
        >
          ...
          <div className="relative pl-6 mt-2">
            ...
            <div
              className="absolute left-2 top-0 bottom-0 w-1 bg-green-500 rounded-full z-0"
